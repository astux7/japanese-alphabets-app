class Hiragana
  def initialize(letter = nil, hiragana_char = nil,reading = nil, translation = nil,thumbImage=nil)
    @letter = letter
  ...
  All = [
    Hiragana.new( 'Romaji', 'Hiragana', "Reading", "Meaning",'alfa.png'),
     #vowels
    Hiragana.new( 'あ', '[あ]お', "{a o}", "Blue",'alfa.png'),
    Hiragana.new( 'い', '[い]す', "{i su}", "Chair",'alfa.png'),
    Hiragana.new( 'う', '[う]で', "{u de}", "Arm",'alfa.png'),
    Hiragana.new( 'え', '[え]いが', "{e i ga}", "Movie",'alfa.png'),
    Hiragana.new( 'お', '[お]んな', "{o n na}", "Female",'alfa.png'),
    #k-line
    Hiragana.new( 'か', '[か]いしゃ', "{ka i sha}", "Company",'alfa.png'),
    Hiragana.new( 'き', '[き]ょう', "{ki ō}", "Today",'alfa.png'),
    Hiragana.new( 'く', '[く]る', "{ku ru}", "Come",'alfa.png'),
    Hiragana.new( 'け     ', '[あ]お', "{a o}", "Blue",'alfa.png'),
    Hiragana.new( 'こ     ', '[あ]お', "{a o}", "Blue",'alfa.png'),
    #s-line
    Hiragana.new( 'さ     ', '[あ]お', "{a o}", "Blue",'alfa.png'),
    Hiragana.new( 'し', '[し]お', "{shi o}", "Salt",'alfa.png'),
    Hiragana.new( 'す', '[す]し', "{su shi}", "Sushi",'alfa.png'),
    Hiragana.new( 'せ', '[せ]んせい', "{se n se i}", "Teacher",'alfa.png'),
    Hiragana.new( 'そ', '[そ]こ', "{so ko}", "Bottom",'alfa.png'),
    #t-line
